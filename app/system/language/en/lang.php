...
return [
    ...
    'copyright' => 'Gracias por usar <a target="_blank" href="http://tastyigniter.com">TastyIgniter</a>',
    'version' => '<b>Versión:</b> %s',

    'no_database' => [
        'label' => 'Se ha producido Error de base de datos',
    ...
    'not_found' => [
        ...
        'layout' => "El diseño ': nombre ' no se encuentra.",
        'partial' => "La parcial ': nombre ' no se encuentra.",
    ...
    'activities' => [
        ...
        'button_mark_as_read' => 'Marcar todo como leido',
    ...
    'countries' => [
        ...
        'help_iso' => 'Más información sobre <a target="_blank" href="http://en.wikipedia.org/wiki/ISO_3166-1"> ISO Alpha 2 & 3</a>',
    ],
    ...
    'extensions' => [
        ...
        'text_empty' => 'Hay no hay extensiones disponibles.',
        ...
        'button_settings' => 'Administrar ajustes',
        ...
        'alert_delete_warning' => 'Estás a punto de eliminar el %s de la extensión <b>%s</b>',
        'alert_delete_confirm' => '¿Está seguro que desea eliminar el %s asociado? Esto no se puede deshacer!',
    ...
    'languages' => [
        ...
        'text_filter_search' => 'Buscar por nombre.',
        'text_filter_file' => 'Ver todas las traducciones',
        'text_filter_translations' => 'Filtrar traducciones.',
        'text_empty' => 'Hay no hay idiomas disponibles.',
        'text_empty_translations' => 'No hay traducciones disponibles.',
        'text_files' => 'archivos',
        'text_locale_strings' => 'Cadenas locales (%s%% traducidas, %s cadenas)',
        'text_current_build' => 'Construcción actual: %s',
        'text_title_update_available' => 'Actualizaciones disponibles',
        'text_title_no_update_available' => 'No hay actualizaciones disponibles',
        'text_update_available' => 'Hay nuevas actualizaciones disponibles para (%s). Sólo se actualizarán las cadenas de traducción no modificadas.',
        ...
        'label_image' => 'Ícono',
        'label_idiom' => 'Idioma',
        'label_check_updates' => 'Comprobar las actualizaciones',

        'button_new' => 'Nuevo Grupo',
        'button_browse' => '<i class="fa fa-globe"></i>&nbsp;&nbsp;Buscar más idiomas&nbsp;&nbsp;<i class="fa fa-external-link-alt"></i>',
        'button_check' => '<i class="fa fa-refresh"></i>&nbsp;&nbsp;Comprobar las actualizaciones',
        'button_apply_update' => 'Aplicar actualizaciones',
        ...
        'alert_save_changes' => 'Los cambios se perderán si no los guarda antes de editar otro archivo de idioma.',
    ...
    'mail_templates' => [
        ...
        'text_edit_partial_title' => 'Correo Parcial: Actualizar',
        ...
        'text_password_reset_request' => 'Email de restablecimiento de contraseñas del cliente',
        'text_password_reset_request_alert' => 'Email de restablecimiento de contraseñas del cliente',
        'text_password_reset' => 'Email de restablecimiento de contraseñas del cliente',
        'text_password_reset_alert' => 'Email de restablecimiento de contraseñas para el admin',
        'text_order' => 'Correo electrónico del pedido de cliente',
        'text_reservation' => 'Correo electrónico de reserva del cliente',
        'text_internal' => 'Mensaje interno',
        'text_contact' => 'Correo de contacto al admin',
        'text_registration_alert' => 'Correo electrónico de alerta de registro a admin',
        'text_order_alert' => 'Correo electrónico de alerta de pedido a admin',
        'text_reservation_alert' => 'Alerta de una reserva a admin',
        'text_order_update' => 'Actualizar estado de pedido con email al cliente',
    ...
    'mail_variables' => [
        ...
        'text_group_customer' => 'Variables del cliente',
        ...
        'text_group_staff_reset' => 'Variables de restablecimiento de contraseña del Staff',
        'text_staff_name' => 'Nombre del Staff',
        'text_staff_reset_link' => 'URL para restablecer la contraseña del Staff',
        ...
        'text_order_address' => 'Dirección del cliente para la entrega del pedido',
        'text_invoice_number' => 'Teléfono del cliente',
        'text_invoice_date' => 'Teléfono del cliente',
        ...
        'text_order_totals' => 'Conjunto del total de Pedidos',
        ...
        'text_reservation_view_url' => 'URL de la vista de reserva',
        ...
        'text_contact_topic' => 'Asunto de contacto',
    ...
    'request_logs' => [
        'text_title' => 'Registros de Peticiones',
        'text_form_name' => 'Registro de Petición',
        'text_filter_search' => 'Buscar por nombre.',
        'text_empty' => 'No hay registros de peticiones disponibles.',
    ...
    'settings' => [
        ...
        'text_tab_mail' => 'Correo electrónico',
        ...
        'text_tab_desc_site' => 'Configure el país, el idioma, la moneda y la zona horaria por defecto de su sitio.',
        ...
        'text_tab_title_taxation' => 'Impuestos',
        'text_tab_title_invoice' => 'Facturación',
        'text_tab_title_order' => 'Pedido',
        'text_tab_title_reservation' => 'Reservacion',
        'text_tab_title_maintenance' => 'Mantenimiento',
        'text_tab_title_system_log' => 'Configuración de Log',
        ...
        'text_internal_sequence_prefix' => 'Prefijo para secuencia interna de numeración',
        'text_menu_price_include_tax' => 'Los precios del Menú ya incluyen el impuesto',
        ...
        'label_site_email' => 'Correo electrónico del Restaurante',
        'label_site_logo' => 'Logo del restaurante',
        'label_timezone' => 'Zona horaria predeterminada',
        'label_site_currency' => 'Moneda predeterminada',
        ...
        'label_distance_unit' => 'Unidad Distancia',
        ...
        'label_tax_menu_price' => 'Precio impuesto del menú',
        'label_tax_delivery_charge' => 'Cargo de impuesto al Domicilio',
        'label_default_order_status' => 'Estado del Pedido predeterminado',
        'label_processing_order_status' => 'Estado de Pedido Procesando',
        'label_completed_order_status' => 'Estado del Pedido Completo',
        'label_canceled_order_status' => 'Estado del pedido cancelado',
        'label_menus_page' => 'Página de elementos del menú',
        'label_guest_order' => 'Permitir pedidos a invitados',
        'label_location_order' => 'Rechazar pedidos fuera del área de entrega',
        'label_invoice_prefix' => 'Prefijo de la Factura',
        'label_default_reservation_status' => 'Estado de la reserva por defecto',
        'label_confirmed_reservation_status' => 'Estado de la Reserva confirmada',
        'label_canceled_reservation_status' => 'Estado de la reserva cancelada',
        ...
        'alert_delete_setup_files' => '¡<b>ALERTA DE SEGURIDAD!</b> ¡Borrar los archivos de configuración para impedir que alguien más sobrescriba su sitio.',

        'help_timezone' => 'La zona horaria predeterminada. Elija una ciudad con la misma zona horaria que su restaurante.',
        ...
        'help_detect_language' => 'Activar o desactivar la detección del idioma del navegador del usuario. Si se activa, su sitio se traducirá al idioma del navegador.',
        ...
        'help_default_geocoder' => 'Dígale al sistema qué servicio geocodificador usar cuando geocodifiqe las direcciones. \'Chain\' es un geocodificador especial que ejecuta Google y el geocodificador open street maps y se detiene una vez que obtiene una respuesta válida.',
        'help_site_currency' => 'Habilitar más monedas desde Localización > Monedas.',
        'help_currency_converter_oer_api' => 'Puedes <a target="_blank" href="https://openexchangerates.org/signup/">registrarte aquí</a> para obtener tu API en Open Exchange Rates.',
        'help_currency_converter_fixer_api' => 'Puedes <a target="_blank" href="https://fixer.io/signup/">registrarte aquí</a> para obtener tu API de Fixer.io.',
        'help_special_category' => 'Seleccione que categoría utilizar automáticamente para menús especiales',
        ...
        'help_tax_delivery_charge' => 'Establecer si el cargo de entrega está sujeto a impuestos',
        ...
        'help_processing_order_status' => 'Seleccione el estado del pedido que debe alcanzar una orden antes de que comience la reducción del stock',
        'help_completed_order_status' => 'Seleccione el estado del pedido para marcar un pedido como completado antes de que se crea la factura de la orden y un cliente puede dejar comentarios',
        ...
        'help_menus_page' => 'Elija una página para mostrar sus elementos del menú',
        'help_reservation_page' => 'Elija una página para mostrar su formulario de reserva',
        'help_guest_order' => 'Permitir al cliente realizar un pedido sin crear una cuenta.',
        'help_location_order' => 'Si está deshabilitado, el cliente podrá pedir sin ingresar el código postal o la dirección.',
        ...
        'help_confirmed_reservation_status' => 'Seleccione el estado de la reserva para marcar una reserva como confirmada antes de que la tabla esté reservada',
        'help_delete_thumbs' => 'Esto eliminará las Miniaturas creadas. Nota: las miniaturas se crean automáticamente.',
        'help_media_max_size' => 'El límite de tamaño máximo (en kilobytes) para archivo al cargar.',
        'help_media_extensions' => 'Las extensiones de archivo permitidas para los archivos subidos. Las extensiones múltiples pueden ser separadas por comas.',
        'help_media_upload' => 'Activar o desactivar la carga de archivos',
        'help_media_new_folder' => 'Activar o desactivar la creación de carpetas',
        'help_media_copy' => 'Activar o desactivar la copia de archivos/carpetas',
        'help_media_move' => 'Habilitar o deshabilitar el movimiento de archivo/carpeta',
        ...
        'help_sendmail_path' => 'Por favor especifique la ruta de envio de correo.',
        ...
        'help_order_email' => 'Enviar un mail de confirmación al correo electrónico al cliente, administración y ubicación después de crear un nuevo Pedido',
        'help_reservation_email' => 'Enviar un correo de confirmación al correo electrónico al cliente, administración y ubicación cuando se recibe una nueva reserva',
        'help_enable_request_log' => 'Si se registran las peticiones erróneas del navegador, como los errores 404.',
        'help_maintenance' => 'Habilite para evitar que los clientes vean su web. Se mostrará el mensaje de mantenimiento a clientes excepto para sesión admin.',
    ...
    'system_logs' => [
        ...
        'button_empty' => '<i class="fa fa-eraser"></i>&nbsp;&nbsp;Vaciar registro',
    ...
    'themes' => [
        ...
        'text_files' => 'archivos',
        'text_files_data' => 'archivos y datos',
        'text_locked_child' => 'Tema bloqueado: crear un tema hijo',
        ...
        'help_component_alias' => 'NO CAMBIES. Excepto que sepas lo que estás haciendo.',
        'help_override_partial' => 'El archivo parcial del componente seleccionado se copiará en el directorio parcial del tema activo en <code>%s</code>.',
        ...
        'alert_delete_warning' => 'Usted está a punto de borrar el %s del tema <b>%s</b>',
        'alert_delete_confirm' => '¿Está seguro que desea eliminar estos %s? Esto no se puede deshacer!',
        'alert_theme_locked' => 'Este es un tema bloqueado, los cambios están restringidos, crea un tema secundario para hacer cambios.',
        ...
        'alert_customize_not_active' => 'Sólo se puede personalizar un tema activo.',
    ],
    ...
    'updates' => [
        ...
        'progress_disable_maintenance' => 'Restaurando/Desactivando modo de mantenimiento&#8230;',
        ...
        'button_recommended_extension' => 'Instalar las extensiones recomendadas...',
        'button_recommended_theme' => 'Instalar un tema recomendado...',
        'button_install' => 'Instalación seleccionada...',
        ...
        'alert_item_to_ignore' => 'Seleccione item(s) o ignore.',
        'alert_no_carte_key' => 'No se ha especificado ninguna clave de carta',
        'alert_no_items' => 'item(s) no especificado.',
    ],
];
