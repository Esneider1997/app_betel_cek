<div class="alert text-reset">
    ...
    <ol class="pl-3">
        ...
        <li>In your facebook app’s dashboard, on the <b>Settings</b> tab set the <b>Valid OAuth redirect URIs</b>
            to <span
                style="color:green"><?php echo e($formModel->getProvider('facebook')->makeEntryPointUrl('callback')); ?></span>
        </li>
    </ol>
</div>
<?php /**PATH C:\xampp\htdocs\testigniter/extensions/igniter/socialite/socialiteproviders/facebook/info.blade.php ENDPATH**/ ?>