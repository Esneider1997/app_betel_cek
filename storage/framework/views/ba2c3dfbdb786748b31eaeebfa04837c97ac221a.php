<div class="alert text-reset">
    ...
    <ol class="pl-3">
        ...
        <li>
            Set <b>Website</b> to <span style="color:green"><?php echo e(url()->to('')); ?></span> and <b>Callback URL</b> to
            <span
                style="color:green"><?php echo e($formModel->getProvider('twitter')->makeEntryPointUrl('callback')); ?></span>
        </li>
...
<?php /**PATH C:\xampp\htdocs\testigniter/extensions/igniter/socialite/socialiteproviders/twitter/info.blade.php ENDPATH**/ ?>