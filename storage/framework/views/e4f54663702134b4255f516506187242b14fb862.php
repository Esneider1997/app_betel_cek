<div class="alert text-reset">
    ...
    <ol class="pl-3">
        ...
        <li>
            ...
            <span style="color:green"><?php echo e($formModel->getProvider('google')->makeEntryPointUrl('callback')); ?></span>
            and click create. It will show you the Client ID and Client Secret which should be copied into the fields
            below.
        </li>
    </ol>
</div>
<?php /**PATH C:\xampp\htdocs\testigniter/extensions/igniter/socialite/socialiteproviders/google/info.blade.php ENDPATH**/ ?>