<div class="alert text-reset">
    ...
    <ol class="pl-3">
        ...
        <li>After registering with Plivo, you will be provided with a phone number, application id, ​and auth token,
            enter them below, and click on Save Changes.
        </li>
        <li>That's it! Twilio SMS channel has been configured!</li>
    </ol>
</div>
<?php /**PATH C:\xampp\htdocs\testigniter/extensions/igniterlabs/smsnotify/smschannels/plivo/info.blade.php ENDPATH**/ ?>